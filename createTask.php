...
?>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Create a New Task</h3>
                    <ol class="breadcrumb">
                        <li><a style="color:#800000;" href="task.php">Tasks</a></li>
                        <li class="active">Create a New Task</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form style action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                        <div class="col-xs-12 col-sm-12 col-lg-12">
                            ...
                            <div class="form-group">
                                <label for="inputTask">Description</label>
                                <input type="text" class="form-control" id="inputTask" name="inputTask" placeholder="Enter Description">
                            </div>
                            <div class="form-group">
                                <label for="inputDuration">Task Duration in Hours</label>
